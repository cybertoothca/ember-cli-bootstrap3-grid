...
module('Integration | Component | twbs clearfix', function (hooks) {
  ...
  test('when index is null', async function (assert) {
    ...
    await render(hbs`<TwbsClearfix @columnCount={{3}} @visible-xs={{true}} @index={{index}} />`);
  ...
  test('when columnCount is null', async function (assert) {
    ...
    await render(hbs`<TwbsClearfix @columnCount={{columnCount}} @visible-xs={{true}} @index={{0}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();
  });
  ...
  test('when rendering a clearfix for all sizes every three columns', async function (assert) {
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{0}} @visible-all={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{1}} @visible-all={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{2}} @visible-all={{true}} />`);
    ...
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{3}} @visible-all={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();
  });

  test('when rendering three columns', async function (assert) {
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{0}} @visible-xs={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{1}} @visible-xs={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{2}} @visible-xs={{true}} />`);
    ...
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{3}} @visible-xs={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();
  });

  test('when rendering three columns for two different sizes', async function (assert) {
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{0}} @visible-sm={{true}} @visible-md={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{1}} @visible-sm={{true}} @visible-md={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{2}} @visible-sm={{true}} @visible-md={{true}} />`);
    ...
    await render(hbs`<TwbsClearfix @columnCount={{3}} @index={{3}} @visible-sm={{true}} @visible-md={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();
  });

  test('when rendering two columns', async function (assert) {
    await render(hbs`<TwbsClearfix @columnCount={{2}} @index={{0}} @visible-xs={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{2}} @index={{1}} @visible-lg={{true}} />`);
    assert.dom('div.twbs-clearfix').doesNotHaveAttribute('style');
    assert.dom('div.twbs-clearfix').hasClass('clearfix');
    assert.dom('div.twbs-clearfix').hasClass('visible-lg-block');
    assert.dom('div.twbs-clearfix').hasNoClass('visible-md-block');
    ...
    await render(hbs`<TwbsClearfix @columnCount={{2}} @index={{2}} @visible-xs={{true}} />`);
    assert.dom('.twbs-clearfix').isNotVisible();

    await render(hbs`<TwbsClearfix @columnCount={{2}} @index={{3}} @visible-md={{true}} />`);
    assert.dom('div.twbs-clearfix').doesNotHaveAttribute('style');
    assert.dom('div.twbs-clearfix').hasClass('clearfix');
    assert.dom('div.twbs-clearfix').hasNoClass('visible-lg-block');
    assert.dom('div.twbs-clearfix').hasClass('visible-md-block');
